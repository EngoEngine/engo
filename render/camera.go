...
func (cam *CameraSystem) New(w *ecs.World) {
	...
	if CameraBounds.Max.X == 0 && CameraBounds.Max.Y == 0 {
		CameraBounds.Max = math2d.Point{X: engo.GameWidth(), Y: engo.GameHeight()}
	}
...
func (cam *CameraSystem) FollowEntity(basic *ecs.BasicEntity, space *common2.SpaceComponent, trackRotation bool) {
