...
type Shader interface {
	...
	Pre()
	Draw(*RenderComponent, *common2.SpaceComponent)
	Post()
}
...
func (s *basicShader) Draw(ren *RenderComponent, space *common2.SpaceComponent) {
...
func (s *basicShader) updateBuffer(ren *RenderComponent, space *common2.SpaceComponent) {
...
func (s *basicShader) generateBufferContent(ren *RenderComponent, space *common2.SpaceComponent, buffer []float32) bool {
	// We shouldn't use common2.SpaceComponent to get width/height, because this usually already contains the Scale (which
...
func (l *legacyShader) updateBuffer(ren *RenderComponent, space *common2.SpaceComponent) {
	if len(ren.bufferContent) == 0 {
...
func (l *legacyShader) generateBufferContent(ren *RenderComponent, space *common2.SpaceComponent, buffer []float32) bool {
	w := space.Width
	h := space.Height
...
func (l *legacyShader) Draw(ren *RenderComponent, space *common2.SpaceComponent) {
...
func (l *textShader) updateBuffer(ren *RenderComponent, space *common2.SpaceComponent) {
...
func (l *textShader) generateBufferContent(ren *RenderComponent, space *common2.SpaceComponent, buffer []float32) bool {
	var changed bool
...
func (l *textShader) Draw(ren *RenderComponent, space *common2.SpaceComponent) {
	if l.lastBuffer != ren.buffer || ren.buffer == nil {
		l.updateBuffer(ren, space)
